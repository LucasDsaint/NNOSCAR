    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(max_length=255, verbose_name='Local', blank=True)),
                ('line1', models.CharField(max_length=255, verbose_name='Data')),
                ('line2',  models.TextField(verbose_name='Horario', help_text='Tell us anything we should know when delivering your order.', blank=True)),
