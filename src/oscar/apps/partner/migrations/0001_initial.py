    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line1', models.CharField(max_length=255, verbose_name='Local')),
                ('line2',  models.DateTimeField(auto_now_add=True, verbose_name='Data')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_excl_tax', models.DecimalField(max_digits=12, decimal_places=0, blank=True, verbose_name='Price (excl. tax)', null=True)),
                ('price_retail', models.DecimalField(max_digits=12, decimal_places=0, blank=True, verbose_name='Price (retail)', null=True)),
                ('cost_price', models.DecimalField(max_digits=12, decimal_places=0, blank=True, verbose_name='Cost Price', null=True)),
