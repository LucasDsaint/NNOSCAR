    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incl_tax', models.DecimalField(decimal_places=0, default=0, max_digits=12, verbose_name='Surcharge (inc. tax)')),
                ('excl_tax', models.DecimalField(decimal_places=0, default=0, max_digits=12, verbose_name='Surcharge (excl. tax)')),
