    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line2',  models.DateTimeField(max_length=255, verbose_name='Horario')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line_price_incl_tax', models.DecimalField(max_digits=12, decimal_places=0, verbose_name='Price (inc. tax)')),
                ('line_price_excl_tax', models.DecimalField(max_digits=12, decimal_places=0, verbose_name='Price (excl. tax)')),
                ('line_price_before_discounts_incl_tax', models.DecimalField(max_digits=12, decimal_places=0, verbose_name='Price before discounts (inc. tax)')),
                ('line_price_before_discounts_excl_tax', models.DecimalField(max_digits=12, decimal_places=0, verbose_name='Price before discounts (excl. tax)')),
                ('unit_cost_price', models.DecimalField(max_digits=12, decimal_places=0, blank=True, verbose_name='Unit Cost Price', null=True)),
                ('unit_price_incl_tax', models.DecimalField(max_digits=12, decimal_places=0, blank=True, verbose_name='Unit Price (inc. tax)', null=True)),
                ('unit_price_excl_tax', models.DecimalField(max_digits=12, decimal_places=0, blank=True, verbose_name='Unit Price (excl. tax)', null=True)),
                ('unit_retail_price', models.DecimalField(max_digits=12, decimal_places=0, blank=True, verbose_name='Unit Retail Price', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(default=1, verbose_name='Quantity')),
                ('price_incl_tax', models.DecimalField(max_digits=12, decimal_places=0, verbose_name='Price (inc. tax)')),
                ('price_excl_tax', models.DecimalField(max_digits=12, decimal_places=0, verbose_name='Price (excl. tax)')),
                ('shipping_incl_tax', models.DecimalField(default=0, max_digits=12, decimal_places=0, verbose_name='Shiping (inc. tax)')),
                ('shipping_excl_tax', models.DecimalField(default=0, max_digits=12, decimal_places=0, verbose_name='Shipping (excl. tax)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_incl_tax', models.DecimalField(max_digits=12, decimal_places=0, verbose_name='Order total (inc. tax)')),
                ('total_excl_tax', models.DecimalField(max_digits=12, decimal_places=0, verbose_name='Order total (excl. tax)')),
                ('shipping_incl_tax', models.DecimalField(default=0, max_digits=12, decimal_places=0, verbose_name='Shipping charge (inc. tax)')),
                ('shipping_excl_tax', models.DecimalField(default=0, max_digits=12, decimal_places=0, verbose_name='Shipping charge (excl. tax)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(default=0, max_digits=12, decimal_places=0, verbose_name='Amount')),
